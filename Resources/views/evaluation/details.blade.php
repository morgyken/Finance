        ...
        <div class="box-body">
            <div class="col-md-12">
                <div class="col-md-6">
                    <dl class="dl-horizontal">
                        <dt>Name:</dt>
                        <dd>{{$payment->patients?$payment->patients->full_name:'Walkin Patient'}}</dd>
                        <dt>Receipt:</dt>
            ...
            <div class="col-md-6">
                @if(!empty($payment->jambopay))
                    <h4>JamboPay</h4>
                    Amount: Ksh {{number_format($payment->jambopay->Amount,2)}}<br/>
                    Bill Number: {{$payment->jambopay->BillNumber}}
                    <hr/>
                @endif
