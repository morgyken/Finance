                    ...
                    <table class="table table-striped table-condensed table-responsive" id="patients">
                        <tbody>
                            ...
                            <tr id="patient{{$patient->patient_id}}">
                                ...
                                <td>
                                    <a class="btn btn-primary btn-xs" href="{{route('finance.evaluation.pay',['patient'=>$patient->id])}}">
                                        <i class="fa fa-hand-lizard-o"></i> Receive Payment</a>
                                    <a class="btn btn-info btn-xs" href="{{route('finance.evaluation.invoice',$patient->id)}}">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$patient->mobile}}</td>
                                <td>
                                    <a class="btn btn-primary btn-xs" href="{{route('finance.evaluation.pay',['patient'=>$patient->id,'invoice'=>true])}}">
                                        <i class="fa fa-hand-lizard-o"></i> Receive Payment</a>
                                    <a class="btn btn-success btn-xs" href="{{route('finance.evaluation.individual_account',$patient->id)}}">
                                        <i class="fa fa-eye-slash"></i> View Account</a>
                                </td>
